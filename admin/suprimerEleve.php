...
<body>
        ...
        if ($supprimer == "supprimer") {
                $suprim = "DELETE FROM eleve WHERE id= $id ";
                $resu = $bdd->query($suprim);

                //echo $resu;

                echo "<br><br><center> Elève correctement supprimer ! </center><br><br>";
                echo "<center><br><br><a href=\"javascript:history.go(-1)\"><input type='button' value='Terminer'/></a></center>";
        } else {
                echo "<br><br><center> La suppression de l'éléve a échoué ! </center><br><br>";
                echo "<center><br><br><a href=\"javascript:history.go(-1)\"><input type='button' value='Terminer'/></a></center>";
        }
